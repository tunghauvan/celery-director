...
class Config(object):
    def __init__(self, home_path=None, config_path=None):
        ...
        self.DIRECTOR_HOME_WORKFLOW = env.str("DIRECTOR_HOME_WORKFLOW", str(Path(self.DIRECTOR_HOME).resolve() / "workflows.yml"))
        self.DIRECTOR_HOME_TASKS = env.str("DIRECTOR_HOME_TASKS", str(Path(self.DIRECTOR_HOME).resolve() / "tasks"))
